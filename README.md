...
aws cloudformation create-stack --stack-name $SERVICE-$NAME-$ENV --parameters ParameterKey=Environment,ParameterValue=$ENV --parameters ParameterKey=ServiceName,ParameterValue=$NAME --template-body file://./ecs-service.yaml --capabilities=CAPABILITY_IAM